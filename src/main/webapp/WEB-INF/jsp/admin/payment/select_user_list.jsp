...
$(document).ready(function() {
	...
	$('div.title').text(opener.seq_title + ' > 수강생 등록');
...
function list_page(){
	...
	$("#pform").attr("action", "/admin/payment/userList.do");
    frm.cPage.value = 1;
    frm.submit();
}
...
${result }
    <form name="pform" id="pform" action="/admin/payment/userList.do" method="post">
    ...
    <div class="button" style="text-align:center;" >
        <a href="#" onclick="applyUser('Y');" class="btn blue big" style="padding-left:20px; padding-right:20px; margin:3px 5px">등록</a>
        <a href="#" onclick="applyUser('N');" class="btn gray big" style="padding-left:20px; padding-right:20px; margin:3px 5px">취소</a>
