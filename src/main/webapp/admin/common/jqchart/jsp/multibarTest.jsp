...
$(document).ready(function(){
	...
	// (필수) 챠트데이타 : 바수만큼 처리 [<값>,...] 
	var chart01Data01 = [10, 20, 30, 40, 50, 630, 70, 810, 90, 100, 110, 190]; 
	var chart01Data02 = [5, 0, 195, 230, 25, 30, 430, 50, 630, 60, 60, 90]; 
	var chart01Data03 = [80, 60, 20, 30, 220, 10, 30, 90, 120, 50, 160, 200]; 
	
	// (필수) bar 항목라벨 정의 : 바수만큼 등록 ex)[{label : '항목명'}, ...];
	var chart01SerLabel = [{label : '일상점검'}, {label : '장비점검'}, {label : '법정점검'}];
	...
	// (선택) y축 라벨
 	var chart01YLabel = '';
	// (필수) 챠트 rendering 처리
	var chart01 = $.jqplot (chart01Id, [chart01Data01, chart01Data02, chart01Data03], 
