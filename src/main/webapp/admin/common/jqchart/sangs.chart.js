...
/**
 * -----------------------
 * 라인챠트(멀티라인가능), y축 최소/최대 설정
 * -----------------------
 */
$.setLineChartOption02 = function(tickData, yaxisUnit, ymin, ymax) {
    var options = {
        animate: !$.jqplot.use_excanvas,
        seriesColors: chartSeriesColors,
        grid : {
 ...
 * -----------------------
 */
$.setBarChartOption01 = function(tickData, yaxisUnit, ymin, ymax) {
    var options = {
        // Only animate if we're not using excanvas (not in IE 7 or IE 8)..
        animate: !$.jqplot.use_excanvas,
        seriesColors: chartSeriesColors,
...
$.setMultiBarChartOption01 = function(tickData, yaxisUnit, seriesLabelData) {
    var options = {
        // Only animate if we're not using excanvas (not in IE 7 or IE 8)..
        animate: !$.jqplot.use_excanvas,
        seriesColors: ["#4bb1cf", "#dd514c", "#faa732",  "#5eb95e", "#839557", "#958c12", "#953579", "#4b5de4", "#d8b83f", "#ff5800", "#0085cc"],
        grid : {
            drawBorder : true,
            drawGridLines : true,
            background : '#FFFFFF',
 ...
 * -----------------------
 */
$.setMultiBarChartOption02 = function(tickData, yaxisUnit, seriesLabelData, legendYn) {
    var options = {
        // Only animate if we're not using excanvas (not in IE 7 or IE 8)..
        animate: !$.jqplot.use_excanvas,
        seriesColors: ["#4bb1cf", "#dd514c", "#faa732",  "#5eb95e", "#839557", "#958c12", "#953579", "#4b5de4", "#d8b83f", "#ff5800", "#0085cc"],
 ...
 * -----------------------
 */
$.setMultiBarChartOption03 = function(titleText , tickData, yaxisUnit, seriesLabelData, ymin, ymax, labelOnOff) {
    var options = {
        ...
        legend: {
            show : labelOnOff // 라벨표시유무 true/false
            , placement: 'inside' // 라벨의 위치 outside, inside (default : inside)
            , location : 'ne' //라벨 위치설정 동(E), 서(W), 남(S), 북(N)
            , marginTop: '0px'
            , rowSpacing : '0px' // Lengn간의 사이공간
