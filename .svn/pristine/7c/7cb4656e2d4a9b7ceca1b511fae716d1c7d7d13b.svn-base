...
<div id="content"> 
		...
		<form id="qform" name="qform"  enctype="multipart/form-data">
			...
			<a href = "#none" onclick="fileDown('E', '0')">☞ 여기</a> 를 클릭하여 샘플 파일을 다운받아 사용 하시기 바랍니다.<br/>
			</p>
...
<div class="popup-btn-group clearfix">
	<div class="btn-popup">
		<a href="#none" onclick="fnPreview(); return false;" class="btn-large-orange"><span>미리보기</span></a> 
	</div>
</div>
