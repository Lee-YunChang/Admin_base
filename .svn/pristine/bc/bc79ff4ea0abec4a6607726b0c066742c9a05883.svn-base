...
function sampleFileDown() {
    downManualDoc('company_sample.xls', 'edu-data/download');
}
</script>

<!-- 본문 > 상단 > 타이틀 -->
<div class="title title_top">기관/단체관리 > 신규기업 엑셀등록<span>기관/단체를 엑셀로 일괄 등록처리할 수 있습니다.</span></div>
...
<!-- 본문 > 메인 > 목록 시작  -->
<form name="writeform" action="/admin/user/companyExcelExec.do" method="post" onsubmit="writeFormCheck(); return false;" enctype="multipart/form-data">
