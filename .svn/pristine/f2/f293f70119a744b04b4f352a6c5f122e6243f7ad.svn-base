				...
				<div class="compleat">
					...
					<div class="floatwrap">
						<ul class="compleat_list al">
							...
							<li><span>기간 :</span><em><c:out value="${map.STUDY_SDATE}"/> ~ <c:out value="${map.STUDY_EDATE}"/>(<c:out value="${map.STUDYTIME_TOT}"/>분)</em></li>
							<li class="last" style="margin-top:10px;">
							<%-- <em>교육인정시간 : <c:out value="${map.STUDYTIME}"/>시간</em> --%></li>
						</ul>
					</div>
