...
function sampleFileDown() {
    downManualDoc('nmber_import_sample.xls', 'webapp/edu-data/download');
}
</script>

<!-- 본문 > 상단 > 타이틀 -->
<div class="title title_top">회원관리 > 비회원 엑셀등록<span>비회원목록을 엑셀로 일괄 등록처리할 수 있습니다.</span></div>
...
<!-- 본문 > 메인 > 목록 시작  -->
<form name="writeform" action="/admin/payment/nmberExcelUpload.do" method="post" onsubmit="writeFormCheck(); return false;" enctype="multipart/form-data">
