...
function sampleFileDown() {
    downManualDoc('user_import_sample.xls', 'edu-data/download');
}
</script>
...
<!-- 본문 > 메인 > 목록 시작  -->
<form name="writeform" action="/admin/user/userListExcelExec.do" method="post" onsubmit="writeFormCheck(); return false;" enctype="multipart/form-data">
