...
/** 
 * AUIGrid-Vue.js v0.9
 * AUIGrid v3.0.8.20200331 for Vue.js
 * Copyright © 2014-2020 AUISoft Co., Ltd. 
 * www.auisoft.net
 */
    // 프로젝트 경로에 맞게 바꾸세요
    ...
    export default {
        ...
        methods : {
            ...
            getSelectedText() {return _self.getSelectedText.call(_self,this.pid);},
            ...
            resetUpdatedColumns(opts) {_self.resetUpdatedColumns.call(_self,this.pid);},
